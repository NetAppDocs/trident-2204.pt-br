...
Todos os seus nós de trabalho do Kubernetes precisam ter as ferramentas iSCSI apropriadas instaladas. link:worker-node-prep.html["aqui"^]Consulte para obter mais detalhes.
