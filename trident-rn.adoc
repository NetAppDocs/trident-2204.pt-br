...
* Análise melhorada de nomes de iniciadores iSCSI. (Edição [n.º 681](https://github.com/NetApp/trident/issues/681[]))
* Corrigido problema em que os parâmetros da classe de armazenamento CSI não eram permitidos. (Edição [n.º 598](https://github.com/NetApp/trident/issues/598[]))
* Declaração de chave duplicada corrigida no CRD Trident. (Edição [n.º 671](https://github.com/NetApp/trident/issues/671[]))
* Corrigidos registos de instantâneos do CSI imprecisos. (Edição [n.º 629](https://github.com/NetApp/trident/issues/629[]))
* Corrigido o problema com a remoção de volumes em nós excluídos. (Edição [n.º 691](https://github.com/NetApp/trident/issues/691[]))
* Adição de manipulação de inconsistências de sistema de arquivos em dispositivos de bloco. (Edição [n.º 656](https://github.com/NetApp/trident/issues/656[]))
* Corrigido problema ao puxar imagens de suporte automático ao definir o `imageRegistry` sinalizador durante a instalação. (Edição [n.º 715](https://github.com/NetApp/trident/issues/715[]))
...
* As conexões de entrada para os endpoints seguros da Trident agora exigem um mínimo de TLS 1,3. (Edição [n.º 698](https://github.com/NetApp/trident/issues/698[]))
...
* *Kubernetes*: O daemonset do Trident agora é executado na classe de prioridade crítica do nó do sistema. (Edição [n.º 694](https://github.com/NetApp/trident/issues/694[]))
